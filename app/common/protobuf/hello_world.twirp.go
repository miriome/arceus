...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(pathPrefix, "common", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
const HelloWorldPathPrefix = "/twirp/common.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "common.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "common", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
