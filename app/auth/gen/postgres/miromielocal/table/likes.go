...
var Likes = newLikesTable("miromielocal", "likes", "")
...
func newLikesTableImpl(schemaName, tableName, alias string) likesTable {
	var (
		...
		allColumns     = postgres.ColumnList{IDColumn, UserIDColumn, PostIDColumn}
		mutableColumns = postgres.ColumnList{UserIDColumn, PostIDColumn}
	)
