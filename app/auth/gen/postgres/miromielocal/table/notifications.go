...
var Notifications = newNotificationsTable("miromielocal", "notifications", "")
...
func newNotificationsTableImpl(schemaName, tableName, alias string) notificationsTable {
	var (
		...
		SentByColumn           = postgres.IntegerColumn("sent_by")
		CreatedAtColumn        = postgres.TimestampzColumn("created_at")
		allColumns             = postgres.ColumnList{IDColumn, UserIDColumn, PostIDColumn, NotificationTypeColumn, ContentColumn, SentByColumn, CreatedAtColumn}
		mutableColumns         = postgres.ColumnList{UserIDColumn, PostIDColumn, NotificationTypeColumn, ContentColumn, SentByColumn, CreatedAtColumn}
	)
